    ...
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
        ...
        <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
            ...
            <div class="col-sm-6 col-md-7 col-lg-7">
                <h4 class="section-subtitle" style="margin-top: 40px;"><b>Update User Info : </b></h4>
                <div class="row">
                    <div class="panel">
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    if(isset($UpdateUser)) {
                                        ...
                                        $UserPassword = htmlentities($password, ENT_QUOTES);
                                        ...
                                        $UploadImageDir = "uploads/admin-image/" . $NewUserImageName;
                                        ...
                                        if(empty($FullName) || empty($UserName) || empty($UserEmail) || empty($UserBio) || empty($UserMobile) || empty($UserAddress)) {
                                            ...
                                            if(!preg_match("/^[a-zA-Zক-য়অ-ঔৎংঃ ঁ. ]+$/", $FullName)) {
                                                ...
                                                if(isset($UserImageName) && !empty($UserImageName)) {
                                                    ...
                                                    $TargetDir = "uploads/admin-image/" . $UserImage;
                                                    unlink($TargetDir);
                                                    ...
                                                    if($ExecuteData) {
                                                        ...
                                                        redirect_to("dashboard.php?page=user-profile");
                                    ...
                                    <form action="<?php $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="UserBio" rows="5" id="textareaMaxLength" maxlength="500"><?= isset($UserBio) ? $UserBio : ''?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="UserMobile" name="UserMobile" value="<?= $UserMobile; ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="UserAddress" name="UserAddress" placeholder="Enter User Name" value="<?= $UserAddress; ?>">
                                        </div>
<!--                                        <div class="form-group">-->
