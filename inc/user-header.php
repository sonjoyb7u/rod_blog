...
<div class="page-header">
    ...
    <div class="leftside-header">
        <div class="logo">
            <a href="../user-dashboard.php" class="on-click">
                <h3>ROD-BLOG</h3>
            </a>
        </div>
    ...
    <div class="rightside-header">
        ...
        <div class="header-section" id="user-headerbox">
            <div class="user-header-wrap">
                <div class="user-photo">
                    <img alt="profile photo" src="admin/uploads/admin-image/<?= $UserImage; ?>" />
                </div>
                <div class="user-info">
                    <span class="user-name"><?= isset($UserFullName) ? $UserFullName : 'ADMIN NAME GOES HERE'?></span>
            ...
            <div class="user-options dropdown-box">
                <div class="drop-content basic">
                    <ul>
                        <li class="<?= $page == 'user-profile' ? 'active-item' : '' ?>"><a href="user-dashboard.php?page=user-profile">Profile</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="header-section">
            <a href="user-dashboard.php?page=user-logout&logout=<?= base64_encode($UserId); ?>" data-toggle="tooltip" data-placement="left" title="Logout"><i class="fa fa-sign-out log-out" aria-hidden="true"></i></a>
        </div>
    </div>
</div>
